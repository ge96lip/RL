    ...
    def q_learning(self):
        ...
        while episode <= self.episode_max and diff > self.threshold:
            ...
            while not end_episode:
                ...
                action = epsilon_greedy(Q, s_current, list_pos, steps, self.epsilon_initial, self.epsilon_final, self.annealing_timesteps, "linear")
                ...
                scheduler = ScheduleLinear(self.annealing_timesteps, lr_initial)
                lr = scheduler.value(steps)
...
class ScheduleLinear(object):
    ...
    def value(self, t):
        ...
        p = self.initial_p + delta_p * (t / self.schedule_timesteps)
        return p
